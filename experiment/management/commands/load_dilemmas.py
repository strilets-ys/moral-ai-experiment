...
GREENE_DILEMMAS = [
    ...
    # Impersonal - Action
    {
        ...
        "dilemma_type": "action",
        "researcher": "G",
        "text": "Alex is a management consultant working on a case for a large corporate client. He has access to confidential information that would be very useful to investors. Alex has a friend who plays the stock market. He owes this friend a sizable sum of money. By providing her with certain confidential information he could help her make a lot of money, considerably more than he owes her. If Alex did this, she would insist on canceling his debt. Releasing information in this way is strictly forbidden by federal law. Alex decides to provide her the confidential information.",
        "subject": "Alex's",
        "low_rating_framework": "deontological",
    },
]
...
KOERNER_BASE_DILEMMAS = {
    "Abduction": {
        "researcher": "K",
        "subject": "Mark's",
        "base_scenario": "Mark is the president of a country. A guerrilla group operating in a conflict zone has abducted a journalist from his country and threatens to behead him if Mark's government does not pay a ransom of one million dollars. ",
    },
    "Vaccine": {
        "researcher": "K",
        "subject": "Nina's",
    ...
    "Construction_Site": {
        "researcher": "K",
        "subject": "Eric's",
        "base_scenario": "Eric is a construction worker on the construction site for a new high-rise of a wealthy and powerful investor. The man is known to increase his wealth by dubious practices. ",
    },
    "Rawanda": {
        "researcher": "K",
        "subject": "Linda's",
        "base_scenario": "Linda is the project leader of a development aid team in a foreign country when ethnic tensions start to escalate. The members of the ethnic majority persecute the members of the ethnic minority. One of Linda's minority employees arrives at the centre of the team after witnessing a colleague being killed by an armed group of majority members. Shortly afterwards, the armed group gathers in front of Linda's centre. ",
    },
}
...
KOERNER_DILEMMA_TEXTS = {
    "Abduction": {
        "bg_prohibition": "Mark is the president of a country. A guerrilla group operating in a conflict zone has abducted a journalist from his country and threatens to behead him if Mark’s government does not pay a ransom of one million dollars. The group will use the ransom money to buy weapons for their guerrilla war, which will cause the deaths of many people. Congress has approved payment of the ransom, but Mark has the power to veto the payment. He decides to veto it.",
        "bs_prohibition": "Mark is the president of a country. A guerrilla group operating in a conflict zone has abducted a journalist from his country and threatens to behead him if Mark’s government does not pay a ransom of one million dollars. The group will use the ransom money to buy food for their families, who live in an area that has been plagued by several droughts. Congress has approved payment of the ransom, but Mark has the power to veto the payment. He decides to veto it.",
        "bg_prescription": "Mark is the president of a country. A guerrilla group operating in a conflict zone has abducted a journalist from his country and threatens to behead him if Mark’s government does not pay a ransom of one million dollars. The group will use the ransom money to buy food for their families, who live in an area that has been plagued by several droughts. As the president, Mark has the power to approve payment of the ransom. He decides to approve it.",
        "bs_prescription": "Mark is the president of a country. A guerrilla group operating in a conflict zone has abducted a journalist from his country and threatens to behead him if Mark’s government does not pay a ransom of one million dollars. The group will use the ransom money to buy weapons for their guerilla war, which will cause the deaths of many people. As the president, Mark has the power to approve payment of the ransom. He decides to approve it.",
    },
    "Vaccine": {
    ...
    "Construction_Site": {
        "bg_prohibition": "Eric is a construction worker on the construction site for a new high-rise of a wealthy and powerful investor. The man is known to increase his wealth by dubious practices. Specifically, he is hiring people to set buildings on fire so that he can evict tenants and convert the buildings into luxury properties. In several cases, tenants were seriously injured or killed, but prosecutors have been unable to convict him. While Eric and the man are on top of the building, Eric sees an opportunity to shove him off the building. The building is high enough for the man to die, which would prevent him from causing more harm to innocent tenants. No one is around to see what is happening, and his death would look like an accident. Eric decides to shove the man off the roof.",
        "bs_prohibition": "Eric is a construction worker on the construction site for a new high-rise of a wealthy and powerful investor. The man is known to increase his wealth by dubious practices. Specifically, he is bribing officials so that he can evict tenants and convert the buildings into luxury properties. In several cases, tenants were unable to find comparable alternatives, but prosecutors have been unable to convict him. While Eric and the man are on top of the building, Eric sees an opportunity to shove him off the building. The building is high enough for the man to die, which would prevent him from causing more harm to innocent tenants. No one is around to see what is happening, and his death would look like an accident. Eric decides to shove the man off the roof.",
        "bg_prescription": "Eric is a construction worker on the construction site for a new high-rise of a wealthy and powerful investor. The man is known to increase his wealth by dubious practices. Specifically, he is bribing officials so that he can evict tenants and convert the buildings into luxury properties. In several cases, tenants were unable to find comparable alternatives, but prosecutors have been unable to convict him. While Eric and the man are on top of the building, the man slips and will fall from the building unless Eric grabs him and pulls him up. The building is high enough for the man to die, which would prevent him from causing more harm to innocent tenants. No one is around to see what is happening, and his death would look like an accident. Eric decides to grab the man and save him.",
        "bs_prescription": "Eric is a construction worker on the construction site for a new high-rise of a wealthy and powerful investor. The man is known to increase his wealth by dubious practices.  Specifically, he is hiring people to set buildings on fire, so that he can evict tenants and convert the buildings into luxury properties. In several cases, tenants were seriously injured or killed, but prosecutors have been unable to convict him. While Eric and the man are on top of the building, the man slips and will fall from the building unless Eric grabs him and pulls him up. The building is high enough for the man to die, which would prevent him from causing more harm to innocent tenants. No one is around to see what is happening, and his death would look like an accident. Eric decides to grab the man and save him.",
    },
    "Rawanda": {
        "bg_prohibition": "Linda is the project leader of a development aid team in a foreign country when ethnic tensions start to escalate. The members of the ethnic majority persecute the members of the ethnic minority. One of Linda’s minority employees arrives at the centre of the team after witnessing a colleague being killed by an armed group of majority members. Shortly afterwards, the armed group gathers in front of Linda’s centre. They threaten to stop an approaching bus and kill all passengers belonging to the ethnic minority if Linda does not hand over the employee. If she hands over your employee, he will be shot and killed by the armed group. Linda decides to hand over the employee to the armed group.",
        "bs_prohibition": "Linda is the project leader of a development aid team in a foreign country when ethnic tensions start to escalate. The members of the ethnic majority persecute the members of the ethnic minority. One of Linda’s minority employees arrives at the centre of the team after witnessing a colleague being killed by an armed group of majority members. Shortly afterwards, the armed group gathers in front of Linda’s centre. They threaten to set one of her team’s cars on fire that is parked in front of the center if Linda does not hand over the employee. If she hands over her employee, he will be shot and killed by the armed group. Linda decides to hand over the employee to the armed group.",
        "bg_prescription": "Linda is the project leader of a development aid team in a foreign country when ethnic tensions start to escalate. The members of the ethnic majority persecute the members of the ethnic minority. One of Linda’s minority employees arrives at the centre of the team after witnessing a colleague being killed by an armed group of majority members. Shortly afterwards, the armed group gathers in front of Linda’s centre. They threaten to set one of her team’s cars on fire that is parked in front of the center if Linda does not hand over the employee. If she hands over her employee, he will be shot and killed by the armed group. Linda knows of a secret tunnel at her center that would allow her employee to flee without being harmed. Linda lets her employee flee through the tunnel.",
        "bs_prescription": "Linda is the project leader of a development aid team in a foreign country when ethnic tensions start to escalate. The members of the ethnic majority persecute the members of the ethnic minority. One of Linda’s minority employees arrives at the centre of the team after witnessing a colleague being killed by an armed group of majority members. Shortly afterwards, the armed group gathers in front of Linda’s centre. They threaten to stop an approaching bus and kill all passengers belonging to the ethnic minority if Linda does not hand over the employee. If she hands over her employee, he will be shot and killed by the armed group. Linda knows of a secret tunnel at her center that would allow her employee to flee without being harmed. Linda lets her employee flee through the tunnel."
    },
}
